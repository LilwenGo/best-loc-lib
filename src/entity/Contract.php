...
class Contract {
    ...
    public function getLoc_begin_date(): DateTime {
        return new DateTime($this->loc_begin_date);
    }
    
    public function getLoc_end_date(): DateTime {
        return new DateTime($this->loc_end_date);
    }
    
    public function getReturning_date(): DateTime {
        return new DateTime($this->returning_date);
    }
    ...
    public function setLoc_begin_date(DateTime|string $date): void {
        if(is_object($date)) {
            $date = $date->format('Y-m-d H:i:s');
        }
    ...
    public function setLoc_end_date(DateTime|string $date): void {
        if(is_object($date)) {
            $date = $date->format('Y-m-d H:i:s');
        }
    ...
    public function setReturning_date(DateTime|string $date): void {
        if(is_object($date)) {
            $date = $date->format('Y-m-d H:i:s');
        }
